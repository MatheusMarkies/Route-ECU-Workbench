...
public class Config {
    ...
    public static String getColorPalleteProperties(String key) {
        ...
        try (
                InputStream inputStream = Workbench.class.getClassLoader().getResourceAsStream("mspm/color_pallate.properties")) {
            if (inputStream != null) {
    ...
    public static String getTooltipTextProperties(String key) {
        Properties properties = new Properties();
        try (
                InputStream inputStream = Workbench.class.getClassLoader().getResourceAsStream("mspm/tooltips_texts.properties")) {
            if (inputStream != null) {
                properties.load(inputStream);
            } else {

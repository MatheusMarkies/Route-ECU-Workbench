...
public class Workbench extends Application {
    ...
    public static void openActionPopUp(String title, String text, ActionStatusPopUp.ActionStatus actionStatus) {
        try {
            FXMLLoader fxmlMain = new FXMLLoader(Workbench.class.getResource("/mspm/ActionStatusPopUp.fxml"));
    ...
    public static void openUpdatePopUp(Update update) {
        try {
            ...
            scene.getStylesheets().add(Workbench.class.getResource("/mspm/pages/DashboardCSS.css").toString());

    ...
    public void setBadgeStyle(BadgeStyle color) {
        ...
        switch (color) {
            case SUCCESS:
                ...
                textColor = "#005037";
                backgroundImage = ImageUtils.colorizeImage(new Image(Workbench.class.getResource("/mspm/icons/check-circle.png").toString()),
                        Color.web(textColor));
                break;
            case DANGER:
                backgroundColor = "rgba(255, 0, 0, 0.2)";
                textColor = "#990000";
                backgroundImage = ImageUtils.colorizeImage(new Image(Workbench.class.getResource("/mspm/icons/exclamation.png").toString()),
                        Color.web(textColor));
                break;
            case WARNING:
            ...
            case INFO:
                ...
                textColor = "#404040";
                backgroundImage = ImageUtils.colorizeImage(new Image(Workbench.class.getResource("/mspm/icons/info.png").toString()),
                        Color.web(textColor));
                break;
            case COMPLETED:
                backgroundColor = "rgba(0, 134, 78, 0.2)";
            ...
            case PROGRESS:
                backgroundColor = "rgba(255, 0, 0, 0.2)";
                textColor = "#996600";
                backgroundImage = ImageUtils.colorizeImage(new Image(Workbench.class.getResource("/mspm/icons/clock.png").toString()),
                        Color.web(textColor));
                break;
            case OPENING:
                backgroundColor = "rgba(255, 0, 0, 0.2)";
            ...
            case PLANNING:
                backgroundColor = "rgba(255, 0, 0, 0.2)";
                textColor = "#996600";
                backgroundImage = ImageUtils.colorizeImage(new Image(Workbench.class.getResource("/mspm/icons/calendar-clock.png").toString()),
                        Color.web(textColor));
                break;
            default:

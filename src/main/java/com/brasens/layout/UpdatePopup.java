...
import com.brasens.objects.Update;
...
public class UpdatePopup extends AnchorPane {
    ...
    public void render(){
        ...
        ImageView updateImage = new ImageView(
                new Image(Workbench.class.getResource("/mspm/icons/default/rocket-lunch.png").toString())
        );
        ...
        updateButton = new CustomButton(
                "Update",
                new Image(Workbench.class.getResource("/mspm/icons/download.png").toString()),
            ...
            final Animation animation = new Transition() {
                ...
                protected void interpolate(double frac) {
                    ...
                    updateButton.getButtonLabelImageView().setImage(
                            ImageUtils.colorizeImage(new Image(Workbench.class.getResource("/mspm/icons/download.png").toString()),imageColor)
                    );
